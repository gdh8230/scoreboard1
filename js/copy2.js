...
// console.log(book); // { title: '인사이드 자바스크립트', price: 2000 }
// console.log(copyBook); // { title: '인사이드 자바스크립트', price: 2000 }
...
console.log(copyBook); // { title: '인사이드 자바스크립트', price: 2000, name: 'aaa' }
